...
class MovieFormBlock extends React.Component{
  ...
  render(){
    ...
    let moviesNodes = <div className="movie-list">{movies}</div>;
    // }

    // console.log(movies, moviesNodes);
    ...
    return (
      <div>
          ...
          {/* <h2> {this.movies.length} </h2> */}
          {/* <MovieForm addMovie={api._addMovie.bind(this)}/> */}
  ...
  componentDidMount(){
    this._timer = setInterval(() => this.props.movies, 5000);
    this.props.fetchData('/api/movies');
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(MovieFormBlock);
