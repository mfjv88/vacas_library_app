...
import { fetchMovies, moviesAreLoading } from '../action/movies';
...
const mapStateToMoviesProps = (state) => ({
  loading: state.loading.loading,
});

const mapDispatchToMoviesProps = (dispatch) => ({
    moviesLoading: (bool) => dispatch(moviesAreLoading(bool)),
    fetchData: () => dispatch(fetchMovies),
})


export default connect(mapStateToMoviesProps, mapDispatchToMoviesProps)(MovieFormBlock);
